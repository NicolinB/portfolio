...
const TRANSLATIONS = {
  en: {
    ...
    'proj.apetit.desc'        : 'Fast food restaurant site with menu, locations and contact pages. Includes a private /admin panel for content management. SQL database for orders and client feedback. Built with React and Vite.',
    ...
    terminal: [
      ...
      { type: 'output', cls: 'output-cyan',  text: 'SQL/          REST_API/' },
      { type: 'blank' },
    ],
  },
  ...
  ro: {
    ...
    'proj.apetit.desc'        : 'Site restaurant fast food cu meniu, locații și contact. Include panel /admin privat pentru gestionarea conținutului. Bază de date SQL pentru comenzi și feedback clienți. Construit cu React și Vite.',
